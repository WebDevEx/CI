(function(e,t,n,r){
    function o(r,i){
        ...
        }e(t).on("resize",function(){o.init();o.slide(0)});
        ...
        return{current:function(){
            ...
            nav:function(e){
                if(o.navWrapper){o.navWrapper.remove()}o.options.nav=e?e:o.options.nav;
                o.navigation()
            },
            arrows:function(e){
                if(o.arrowsWrapper){o.arrowsWrapper.remove()}o.options.arrows=e?e:o.options.arrows;o.arrows()
            }
        }
    }
    function u(e){
        ...
        if(i===false){u=e.charAt(0).toUpperCase()+e.substr(1);
    ...
    o.prototype.navigation=function(){
        ...
        if(t.slides.length>1){
            ...
            u.on("click touchstart",function(n){n.preventDefault();t.slide(e(this).data("distance"),true)})
        }
    };
    o.prototype.arrows=function(){
        ...
        if(t.slides.length>1){
            ...
            i.right=e("<a />",{href:"#","class":n.arrowMainClass+" "+n.arrowRightClass,"data-distance":"1",html:n.arrowRightText}).appendTo(i);
            i.left=e("<a />",{href:"#","class":n.arrowMainClass+" "+n.arrowLeftClass,"data-distance":"-1",html:n.arrowLeftText}).appendTo(i);
            i.children().on("click touchstart",function(n){n.preventDefault();t.slide(e(this).data("distance"),false)}
            )}
        };
    o.prototype.slide=function(e,t,n){
        ...
        var a=u*i+"px";
        if(r.CSS3support){
            r.wrapper.css({"-webkit-transform":"translate3d("+a+", 0px, 0px)","-moz-transform":"translate3d("+a+", 0px, 0px)","-ms-transform":"translate3d("+a+", 0px, 0px)","-o-transform":"translate3d("+a+", 0px, 0px)",transform:"translate3d("+a+", 0px, 0px)"})
        }
        else
        {r.wrapper.stop().animate({"margin-left":a},r.options.animationTime)}
        if(r.options.nav&&r.navWrapper){r.navWrapper.children().eq(-i).addClass(o).siblings().removeClass(o)}
        r.currentSlide=i;
    ...
    o.prototype.play=function(){
        ...
        if(e.options.autoplay){
            e.auto=setInterval(function(){e.slide(1,false)},
            e.options.autoplay)}
    };
